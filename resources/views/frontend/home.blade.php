...
<head>
    ...
    <style>
        ...
        *{font-family:'Inter',sans-serif;box-sizing:border-box}body{overflow-x:hidden}
        ...
        .navbar-brand{color:#fff!important;font-weight:800;font-size:1.75rem}.navbar-brand span{color:var(--third)}
        ...
        .hero{min-height:100vh;background:linear-gradient(135deg,var(--primary) 0%,#002266 50%,var(--secondary) 100%);display:flex;align-items:center;color:#fff;position:relative;overflow:hidden;padding-top:80px}
        .hero-content{position:relative;z-index:1}
        .hero h1{font-size:3.5rem;font-weight:800;line-height:1.2;margin-bottom:1.5rem;animation:fadeInUp 0.8s ease}
        .hero .lead{font-size:1.25rem;margin-bottom:2rem;animation:fadeInUp 0.8s ease 0.2s forwards;opacity:0}
        .btn-cta{background:var(--third);color:#fff;padding:16px 40px;border-radius:50px;font-weight:600;text-decoration:none;display:inline-flex;align-items:center;gap:10px;transition:all var(--transition-normal);border:2px solid var(--third);animation:fadeInUp 0.8s ease 0.4s forwards;opacity:0}
        .btn-cta:hover{background:transparent;color:#fff;transform:translateY(-3px);box-shadow:0 10px 30px rgba(203,148,48,0.3)}
        .hero-shapes{position:absolute;top:0;right:0;bottom:0;width:50%;overflow:hidden;pointer-events:none}
        .hero-shape{position:absolute;border-radius:50%;opacity:0.1}
        .hero-shape-1{width:400px;height:400px;background:var(--third);top:10%;right:-100px;animation:float 6s ease-in-out infinite}
        .hero-shape-2{width:200px;height:200px;background:#fff;bottom:20%;right:20%;animation:float 8s ease-in-out infinite reverse}
        ...
        .chat-header-text p::before{content:'';display:inline-block;width:8px;height:8px;background:#25d366;border-radius:50%;margin-right:6px;animation:pulse 2s infinite}
        ...
        .contact-options{display:flex;flex-direction:column;gap:10px;margin-top:10px;animation:fadeInUp 0.3s ease}
        ...
        @media(max-width:991.98px){.hero h1{font-size:2.5rem}.section{padding:60px 0}.section-title{font-size:2rem}.navbar-collapse{background:var(--primary);padding:20px;border-radius:15px;margin-top:15px}.about-image::before{display:none}}
        @media(max-width:767.98px){.hero{min-height:auto;padding:120px 0 80px}.hero h1{font-size:2rem}.hero .lead{font-size:1rem}.btn-cta{padding:14px 30px}.section{padding:50px 0}.section-title{font-size:1.75rem}.contact-form{padding:1.5rem}.chat-window{bottom:0;right:0;left:0;width:100%;max-width:100%;height:calc(100vh - 80px);border-radius:20px 20px 0 0}.chat-widget-button{bottom:20px;right:20px;width:60px;height:60px}.hero-shapes{display:none}}
...
<body>
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 h-100 reveal">
                            <div class="card-icon card-icon-{{ ['primary','secondary','third'][$index % 3] }}"><i class="{{ $card->icon ?? 'bi bi-star' }}"></i></div>
                            <h5>{{ $card->title }}</h5>
            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-6 reveal">
                        ...
                        @else
                            <p class="text-muted">We are passionate technologists delivering innovative IT solutions.</p>
                        @endif
                    </div>
                    @if($about && $about->image)
                    <div class="col-lg-6 reveal"><div class="about-image"><img src="{{ asset('storage/' . $about->image) }}" class="img-fluid" alt="About" loading="lazy"></div></div>
                    @endif
                </div>
            </div>
        </section>
        ...
        <section id="services" class="section" style="background:linear-gradient(180deg,#f8f9fa 0%,#fff 100%)">
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 h-100 reveal">
                            <div class="card-icon card-icon-secondary"><i class="{{ $service->icon ?? 'bi bi-gear' }}"></i></div>
                            <h5>{{ $service->title }}</h5>
        ...
        <section id="projects" class="section bg-white">
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom project-card h-100 reveal">
                            @if($project->image)
                            <div style="overflow:hidden"><img src="{{ asset('storage/' . $project->image) }}" class="card-img-top" style="height:220px;object-fit:cover" alt="{{ $project->title }}" loading="lazy"></div>
                            @endif
        ...
        <section class="section subsidiaries-section">
            <div class="container position-relative">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="subsidiary-card reveal">
                            @if($subsidiary->logo)
                            ...
                            @endif
                            <a href="{{ route('subsidiary.show', $subsidiary->slug) }}" class="btn btn-outline-primary">Explore <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                    @endforeach
                </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="contact-form reveal">
                            <form action="{{ route('contact.submit') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mb-4"><label class="form-label">Full Name *</label><input type="text" class="form-control" name="name" required></div>
                                    <div class="col-md-6 mb-4"><label class="form-label">Email *</label><input type="email" class="form-control" name="email" required></div>
                                    <div class="col-md-6 mb-4"><label class="form-label">Phone</label><input type="tel" class="form-control" name="phone"></div>
                                    <div class="col-md-6 mb-4"><label class="form-label">Company</label><input type="text" class="form-control" name="company"></div>
                                    <div class="col-12 mb-4"><label class="form-label">Message *</label><textarea class="form-control" name="message" rows="5" required></textarea></div>
                                    <div class="col-12"><button type="submit" class="btn-submit"><i class="bi bi-send me-2"></i>Send Message</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    ...
                    <div class="social-links">
                        ...
                        <a href="{{ $fb->value }}" target="_blank"><i class="bi bi-facebook"></i></a>
                        @endif
                        @if($ig = $settings['social']->firstWhere('key', 'instagram'))
                        <a href="{{ $ig->value }}" target="_blank"><i class="bi bi-instagram"></i></a>
                        @endif
                        @if($li = $settings['social']->firstWhere('key', 'linkedin'))
                        <a href="{{ $li->value }}" target="_blank"><i class="bi bi-linkedin"></i></a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="footer-links d-flex flex-column gap-2">
                        <a href="#about">About Us</a><a href="#services">Services</a><a href="#projects">Projects</a><a href="#contact">Contact</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="footer-links d-flex flex-column gap-3">
                        @if($address)
                        <div class="d-flex gap-3"><i class="bi bi-geo-alt text-third"></i><span class="text-white-50">{{ $address }}</span></div>
                        @endif
                        @if($email)
                        <div class="d-flex gap-3"><i class="bi bi-envelope text-third"></i><a href="mailto:{{ $email }}">{{ $email }}</a></div>
                        @endif
                        @if($phone)
                        <div class="d-flex gap-3"><i class="bi bi-telephone text-third"></i><a href="tel:{{ $phone }}">{{ $phone }}</a></div>
                        @endif
                    </div>
                </div>
            </div>
            <hr class="border-secondary my-5">
            <div class="text-center"><p class="text-white-50 mb-0">&copy; {{ date('Y') }} {{ $siteName }}. All rights reserved.</p></div>
        </div>
    </footer>
    ...
    <div class="chat-window" id="chatWindow">
        <div class="chat-header">
            <div class="chat-header-info">
                <div class="chat-header-avatar"><i class="bi bi-building"></i></div>
                <div class="chat-header-text"><h5>{{ $siteName }} Support</h5><p>Typically replies instantly</p></div>
            </div>
            <button class="chat-close-btn" id="chatCloseBtn"><i class="bi bi-x-lg"></i></button>
        </div>
        <div class="chat-body" id="chatBody">
            <div class="chat-message bot">
                <div class="chat-message-avatar"><i class="bi bi-building"></i></div>
                <div><div class="chat-message-bubble">Hi! Welcome to {{ $siteName }}. How can we help you today?</div></div>
            </div>
        </div>
        <div class="chat-quick-options" id="quickOptions">
            <button class="quick-option-btn" data-message="I need IT consulting">IT Consulting</button>
            <button class="quick-option-btn" data-message="Web development inquiry">Web Development</button>
            <button class="quick-option-btn" data-message="Get a quote">Get Quote</button>
            <button class="quick-option-btn" data-message="Contact support">Support</button>
        </div>
    ...
    <script>
            ...
            anchor.addEventListener('click', function(e) {
                ...
                if (target) {
                    ...
                    if (nc && nc.classList.contains('show')) {
                        var b = bootstrap.Collapse.getInstance(nc);
                        if (b) b.hide();
                    }
                }
            });
        ...
        var whatsappNumber = '{{ $whatsappClean }}';
        ...
        function handleBotResponse(userMessage) {
            ...
            if (lowerMessage.indexOf('quote') !== -1 || lowerMessage.indexOf('price') !== -1) {
                addMessage("I'd be happy to help you get a quote! Contact us:", 'bot');
                addContactOptions();
                ...
                addContactOptions();
            } else if (lowerMessage.indexOf('contact') !== -1 || lowerMessage.indexOf('support') !== -1) {
                addMessage("Here are the best ways to reach us:", 'bot');
                addContactOptions();
            } else {
                addMessage("Thanks for reaching out! Contact us for assistance:", 'bot');
                addContactOptions();
            }
        }
        ...
        function addContactOptions() {
            ...
            var html = '';
            if (whatsappNumber) {
                html += '<a href="https://wa.me/' + whatsappNumber + '?text=Hello" target="_blank" class="contact-option-card"><div class="contact-option-icon whatsapp"><i class="bi bi-whatsapp"></i></div><div class="contact-option-text"><h6>WhatsApp</h6><p>Chat instantly</p></div></a>';
            }
            if (contactPhone) {
                html += '<a href="tel:' + contactPhone + '" class="contact-option-card"><div class="contact-option-icon phone"><i class="bi bi-telephone-fill"></i></div><div class="contact-option-text"><h6>Call Us</h6><p>' + contactPhone + '</p></div></a>';
            }
            if (contactEmail) {
                html += '<a href="mailto:' + contactEmail + '" class="contact-option-card"><div class="contact-option-icon email"><i class="bi bi-envelope-fill"></i></div><div class="contact-option-text"><h6>Email</h6><p>' + contactEmail + '</p></div></a>';
            }
        ...
        quickOptions.forEach(function(option) { option.addEventListener('click', function() { sendMessage(this.getAttribute('data-message')); }); });
