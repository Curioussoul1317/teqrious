...
@keyframes particleFloat{0%,100%{transform:translateY(0) translateX(0);opacity:0.3}25%{transform:translateY(-20px) translateX(10px);opacity:0.8}50%{transform:translateY(-40px) translateX(-10px);opacity:0.5}75%{transform:translateY(-20px) translateX(5px);opacity:0.7}}
...
.hero-bg-grid{position:absolute;top:0;left:0;right:0;bottom:0;background-image:linear-gradient(rgba(203,148,48,0.1) 1px,transparent 1px),linear-gradient(90deg,rgba(203,148,48,0.1) 1px,transparent 1px);background-size:50px 50px;animation:gridMove 20s linear infinite;opacity:0.5}
.hero-gradient{position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at center,transparent 0%,var(--primary) 70%),linear-gradient(135deg,var(--primary) 0%,#001a5c 50%,var(--secondary) 100%);opacity:0.9}
.hero-scan{position:absolute;left:0;right:0;height:200px;background:linear-gradient(to bottom,transparent,rgba(203,148,48,0.1),transparent);animation:scan 8s linear infinite;pointer-events:none}
.hero-particles{position:absolute;top:0;left:0;right:0;bottom:0;overflow:hidden;pointer-events:none}
.particle{position:absolute;width:4px;height:4px;background:var(--third);border-radius:50%;animation:particleFloat 6s ease-in-out infinite}
...
.particle:nth-child(3){left:35%;top:40%;animation-delay:2s;animation-duration:8s}
.particle:nth-child(4){left:50%;top:70%;animation-delay:0.5s;animation-duration:6s}
.particle:nth-child(5){left:65%;top:30%;animation-delay:1.5s;animation-duration:7s}
.particle:nth-child(6){left:80%;top:50%;animation-delay:2.5s;animation-duration:5s}
.particle:nth-child(7){left:90%;top:80%;animation-delay:3s;animation-duration:9s}
.particle:nth-child(8){left:15%;top:85%;animation-delay:0.8s;animation-duration:6s}
.hero-corner{position:absolute;width:150px;height:150px;border:2px solid rgba(203,148,48,0.3);animation:borderGlow 3s ease-in-out infinite}
...
<body>
    ...
    <header class="hero">
        ...
        <div class="hero-particles"><div class="particle"></div><div class="particle"></div><div class="particle"></div><div class="particle"></div><div class="particle"></div><div class="particle"></div><div class="particle"></div><div class="particle"></div></div>
