...
@section('title', 'Add Subsidiary')
@section('page-title', 'Add Subsidiary')

@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.subsidiaries.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="+960XXXXXXX">
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Recommended: PNG with transparency</small>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle me-1"></i>Create Subsidiary
                </button>
            </div>
        </form>
    </div>
