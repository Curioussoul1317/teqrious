            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="bg-purple bg-opacity-10 rounded d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background-color: rgba(111, 66, 193, 0.1);">
                ...
                <div class="card-body p-0">
                    @forelse($recentBills as $bill)
                        <div class="p-3 border-bottom {{ !$loop->last ? '' : 'border-bottom-0' }}">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <a href="{{ route('admin.bills.show', $bill) }}" class="fw-medium text-dark text-decoration-none">
                                        {{ $bill->bill_number }}
                                    </a>
                                    <p class="text-muted small mb-0">{{ $bill->client->name }} - {{ $bill->project->title }}</p>
                                </div>
                                <div class="text-end">
